...
type 2 diabetes, few data are available regarding the role of the specific fatty
acid composition within serum TAG (TAGFA). In this context, our aim was to
...
Metabolism and Islet Cell Evaluation (PROMISE) cohort of adults (n=477) at-risk
for diabetes. Glucose and insulin from an OGTT were used to calculate the
...
GEE models with TAGFA as mol%, four TAGFA (14:0, 16:0, 14:1n-7, 16:1n-7) had
strong negative associations while most others (e.g. 18:1n-7, 18:1n-9, 20:2n-6, 
...
analysis indicated that four TGFA clustered together and strongly predicted
lower IS. These four TAGFA also correlated highly (r>0.4) with clinically
measured TAG.

**Conclusions**:
We found that higher proportions of a cluster of four TAGFA (14:0, 14:1-7,
16:0, 16:1n-7) strongly predicted lower IS as well as hypertriglyceridemia.
...
It is a strong risk factor for cardiovascular disease [@DAgostino2004a], in addition to other metabolic disorders such as non-is involved in metabolic dysfunction [@Verges2015a; @Kawano2013a; @Alberti2009]. 
