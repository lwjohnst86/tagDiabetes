...
There are some possible explanations to these findings.

{{
There are two sources for endogenous fatty acids: diet and de novo lipogenesis 
(DNL). Given that most fatty acids can come from either source, it is difficult
to 
...
Previous research has shown that carbohydrate intake increases de novo lipogenesis (DNL)
[@Hodson2008a; @Kawano2013a; @Harding2015a; @Hudgins2000a; @Parks1999a]. 
...
[@Chehade2013a; @Verges2015a]. We found that
...
encourage greater DNL to handle the higher blood glucose. {{higher insulin
