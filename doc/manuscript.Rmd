...
There are a few possible explanations to these findings.

{{
Endogenous fatty acids derive from two sources: diet and de novo lipogenesis 
(DNL). While adipose tissue also supplies circulating fatty acids, the stored
fatty acids ultimately originate from these two sources.

Since the majority of fatty acids can be obtained from either source, the specific
composition 

- composition is important
- where it comes from is difficult
- diet can influence, just as DNL can
- diet can also influence DNL
    - more carbs, more DNL
    - more fat, less DNL
- More specific fat in diet, more specific fat in body (generally)
- More carbs, more DNL fat
- Dietary fat contains wide range of fat types, translates to wide range of fats

irrespective of the source, individual fatty acids can have unique physiological 
effects. For instance, 14 to 18 chain
...
that clustered together using the PLS analysis, suggesting a link to
a higher carbohydrate diet, 

which may increase de novo lipogenesis (DNL)
[@Hodson2008a; @Kawano2013a; @Harding2015a; @Hudgins2000a; @Parks1999a] as one
means of lowering blood glucose,
[@Chehade2013a; @Verges2015a] 

lead to higher DNL in an attempt to control blood glucose, thus increasing hepatic
...
dysfunction [@Ma2015a; @Zong2013a; @Lankinen2015a; @Kroger2011a]; however, how
DNL may influence metabolic dysfunction is not well described. One possible explanation
may be the relationship between greater DNL and the types of fatty acids produced.
...
may act as confounding factor and was thus adjusted for. In a previous published
...
<!--
{{ comment on comparing models with and without NEFA }} While NEFA may be a
mediating factor, we found that adjustment for it did not attenuate this
association since TGFA composition is also dictated by other sources for DNL
(e.g. recent meal, DNL from glucose stores, fatty acid recycling, etc.).
