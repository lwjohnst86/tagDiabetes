...
colliding variables (see the [@Greenland1999a] ref for more detail about using
...
There are a few possible explanations to these findings. The composition of the
TGFA fraction is determined by the two sources of dietary fat and de novo
lipogenesis (DNL). And while adipose tissue also supplies circulating fatty
acids, the stored fatty acids ultimately originate from these two sources.
Specific dietary fat as well as carbohydrates can influence DNL activity
{{cite}}. Since the majority of fatty acids can be obtained from either source,
the specific source for fatty acids is extremely difficult to ascertain outside
of highly controlled experimental settings. 
In our findings, the four fatty acids are also highly correlated amongst each other, in addition to
clustering together on their negative association with insulin sensitivity. These
findings suggest that these fatty acids may derived mainly from DNL, given the
evidence that they share a tight DNL pathway. While it may be possible that
these fatty acids also share a common dietary source (e.g. red meat) {{cite}},
dietary sources of these four fatty acids are also high in fatty acids such as
18:0 and 18:1 n-9, which we did not see cluster together.
...
carbohydrate) group. {{talk about Yki-.. study}}. These fatty acids are similar
to the fatty acids we found that clustered together using the PLS analysis.

We found that higher proportions of these four DNL TGFA also highly correlated
with a higher concentration of clinical TG, highlighting a potential relationship
between these four fatty acids, circulating TG, and the 

A higher activity in DNL may be a means to control blood glucose with higher
dietary carbohydrate intake [@Hodson2008a; @Kawano2013a; @Harding2015a;
@Hudgins2000a; @Parks1999a; @Chehade2013a; @Verges2015a], which could increase
hepatic fat stores and increase the amount of TG in circulation. Several studies
have in fact shown a link between higher estimated DNL and an increased risk for
metabolic dysfunction [@Ma2015a; @Zong2013a; @Lankinen2015a; @Kroger2011a];
however, how DNL may influence metabolic dysfunction is not well described. One
possible explanation may be the relationship between greater DNL and the types
of fatty acids produced.

Regardless of the exact source of these fatty acids, our results in addition to
the available scientific evidence emphasizes the importance of the fatty acid
composition on metabolic health, as individual fatty acids can have unique
physiological functions {{cite}}.

The higher concentration of
circulating 14 and 16 carbon fatty acids may then expose tissues to greater
lipotoxicity, for instance from palmitic acid (16:0), which is well-known to
have harmful effects on tissues [@Riserus2008a; @Iggman2010a].
...
encourage greater DNL to handle the higher blood glucose. 
{{higher insulin
resistance may also lead to higher circulating LDL, since they are not taken
up... cite}}
As we found no interaction by time of TGFA on insulin sensitivity, this study
can not determine the exact role of the feedback mechanism. Combined with the
lack of time interaction and the consistent negative association without the
time interaction, these results at least suggest that the feedback mechanism may
not be strongly influential and that TGFA may predict insulin sensitivity over a
six year period. Given the complex biological mechanisms and feedback loops
...
NEFA that are mostly uptaken by the liver and used in TG production [@Nielsen2012a].
