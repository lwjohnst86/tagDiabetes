...
significant associations in the unadjusted GEE model (see `r cite_f('gee_unadj')`) and 
`r nrow(dplyr::filter(gee_adj_df, p.value <= 0.05))` FDR-corrected
significant associations in the adjusted GEE model as shown in `r cite_f('gee_adj')`. 
