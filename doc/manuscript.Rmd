...
of lipoproteins that transport TAG [@Yu2012a]. Likewise, greater TAGFA may
...
Calculator. HOMA largely reflects hepatic insulin resistance, while ISI
...
composition of the TAGFA fraction. Therfore, to confirm the GEE results in a multivariate 
...
sensitivity and beta-cell function measures had a significant median decline of
...
A similar pattern of TAGFA was also associationed with HOMA-IR cross-sectionally
...
TAGFA data were available for 831 participants after 6-years of follow-up. 
They found that most saturated fatty acids had negative , docosapentaenoic acid (22:5n-3),
...
Our study extends these findings by using multiple measurements
of metabolic function and as well as multivariate statistical approaches that
allowed us to identify a cluster of TAGFA.
In another study of a much
...
{{fix this}}
However, while this DNL cluster had a strong negative association
with insulin sensitivity, the magnitude of the association was slightly weaker
compared to clinically measured TAG.
