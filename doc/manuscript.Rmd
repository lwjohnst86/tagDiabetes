...
particular, DNL from simple carbohydrate sources increases the 14 to
...
Given the close biological relationship between circulating NEFA and TAG, NEFA 
...
may be because TAG are biologically destined for uptake by non-hepatic tissue as
they are found mainly in VLDL, at least during fasting. This is in contrast to
NEFA that are mostly uptaken by the liver and used in TAG production [@Nielsen2012a].
