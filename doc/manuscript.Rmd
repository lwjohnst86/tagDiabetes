...
There are a few possible explanations to these findings. Fatty acids, and thus
the TGFA composition, derive from two sources: dietary fat and de novo
lipogenesis (DNL). Adipose tissue also supplies circulating fatty acids,
however, these also ultimately originate from the two sources. Specific dietary
fat and carbohydrates can influence DNL activity {{cite}}. Determining the
specific source of fatty acids is extremely difficult to ascertain outside of
highly controlled experimental settings. However, there are sign that suggest
one source over another. 

The link DNL activity and levels of specific fatty acids has been examined in
several studies. Previous studies that have examined DNL have used
...
carbohydrate) group. {{talk about Yki-.. study}}.  In our findings, the four
fatty acids were highly correlated amongst each other, in addition to clustering
together on their negative association with insulin sensitivity. If these fatty
acids derived from mainly the diet, we would anticipate seeing more correlation
with the 18:0, 18:1, and 18:2 fatty acids, as these fatty acids often share a
dietary source (e.g. meat) {{cite?}} with the four clustering fatty acids. As our
results do not show this, this suggests the common source being DNL and that the
fatty acids may have been produced from higher DNL activity since, again, there
was no strong correlation with 18:0 and 18:1 fatty acids, which would be the
next stage DNL via elongation and/or desaturation of 16:0 and 16:1 fatty acids.

A higher DNL activity may result from a higher carbohydrate intake as a means to
control blood glucose [@Hodson2008a; @Kawano2013a; @Harding2015a; @Hudgins2000a;
@Parks1999a; @Chehade2013a; @Verges2015a], which could increase hepatic fat
stores and increase the amount of TG in circulation. In fact, we found that
higher proportions of these four TGFA also highly correlated with a higher
concentration of clinical TG. Several studies have shown a link between higher
estimated DNL and an increased risk for metabolic dysfunction [@Ma2015a;
@Zong2013a; @Lankinen2015a; @Kroger2011a]; how DNL may influence metabolic
dysfunction is not well understood. Possible explanations may be that higher DNL
produces more of certain fatty acids or that higher DNL increases circulating TG,
which itself is well documented to contribute to metabolic dysfunction {{cite?}}.
...
physiological functions {{cite}}. For instance, a higher concentration of
...
this pattern strongly predicted lower insulin sensitivity. While these fatty
...
mechanisms involved. For example, while greater DNL and higher TGFA may promote
muscle insulin resistance, the reverse may also be true [@Flannery2012a]. Higher
insulin resistance may encourage TGFA to remain in circulation longer {{cite?}}.
...
sensitivity over a six year period. Given the complex biological mechanisms and
...
measured total TG as a indicator of metabolic health.
