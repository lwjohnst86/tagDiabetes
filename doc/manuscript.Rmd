...
applied to the correlation matrix to identify clusters within the TAGFA 
composition. {{expand/clarify, ref suplemental material}}
...
GEE model ({{M#?}}) was adjusted for time, waist circumference, baseline age, ethnicity,
...
other TAGFA. {{clarify, as well as the legend}}
