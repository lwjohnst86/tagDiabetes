...
hypertriglyceridemia with incident type 2 diabetes [@Chien2008a;
...
composition with the pathophysiological factors underlying diabetes,
...
measured TG in a Canadian population at risk for diabetes.
...
`r fa_cor$rng$TAG[2]`) with clinically-measured TG and moderate positive 
...
correlation with clinical TG (r=`r fa_cor_mol$rng$TAG[1]`) while all other fatty
