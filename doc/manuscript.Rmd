...
visits and had complete data). Metabolic characterization, anthropometric
...
`r tab_basic` shows some basic characteristics of the PROMISE cohort. The mean 
follow-up time was `r calc_followup_time()`. There were
